...
p <- list(conjugation_prob = 0.05,       # probability of successful HGT
          ...
          mut_rate = 0.05,              # based on 10^-9 mutations per base in E. coli and a 5 Mb genome
          
          # Antibiotic parameters
          antibiotic_MIC = 4,            # MIC of the antibiotic for the bacteria in question
          dose_conc = 8,                 # increase in concentration of antibiotics after a dose
          dose_first = con_factor*3,     # time at which the first dose is given
          dose_interval = 2,             # time interval (hours) between doses
          dose_number = 6,               # number of doses given
